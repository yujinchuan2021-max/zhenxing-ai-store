...
作者是从12年开始做开源和基础的互联网教育类。所以当一个新时代来临，希望能做更多的普世性教育，AI的发展应该要去惠及每一个人，而不是高高在上的。

所以我做了这款产品。可以将AI的使用门槛做到最低。

希望有更多志同道合的朋友加入我这个项目，本项目未来一直会是开源和开放的，如果需要在我基础上改版或者怎样，请通知我一下。谢谢！
