...
const productSpecs = [
  ...
  ["docker", desktopProduct("docker-desktop", "Docker Desktop", "官方 Windows 桌面产品，内置 MCP Toolkit、Catalog 和 Gateway；枕星AI助手 仅打开官方下载入口。", "https://www.docker.com/products/docker-desktop/", "https://docs.docker.com/ai/mcp-catalog-and-toolkit/get-started/")],
  ...
  ["jetbrains", desktopProduct("jetbrains-intellij-idea", "IntelliJ IDEA", "IntelliJ IDEA 2025.2 起内置官方 MCP Server；枕星AI助手 仅打开官方下载与配置说明。", "https://www.jetbrains.com/idea/download/?section=windows", "https://www.jetbrains.com/help/idea/mcp-server.html")],
...
const resourceSpecs = [
  ...
  },
  {
    ...
    uninstall: "枕星AI助手 当前只打开官方接入说明；断开时从目标 AI 工具删除连接，并关闭专用调试会话。",
  ...
  },
  {
    ...
    uninstall: "枕星AI助手 未安装或修改 Toolkit；用户需在 Docker Desktop 中禁用 Toolkit/Gateway 并撤销授权。",
  ...
  },
  {
    ...
    uninstall: "枕星AI助手 未修改 IDE；断开时在 IntelliJ IDEA 禁用 MCP Server 或从目标客户端删除连接。",
