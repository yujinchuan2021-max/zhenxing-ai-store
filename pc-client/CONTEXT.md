# 枕星AI助手（ZhenXing AI Assistant）

枕星AI助手 帮助 Windows 用户按厂商发现 AI 工具、可接入 AI 的产品及其生态资源，并在明确的本地安全策略下访问、安装和管理它们。官网域名为 `zhenxingai.com`；内部 `aihub` 标识仅为兼容既有用户数据、安装收据和升级链保留。

## 身份

**用户**：
在枕星AI助手 中拥有唯一身份、个人资料和会话的人。
_Avoid_: 账号、客户、社区用户
...
**站内信**：
枕星AI助手 系统在产品内部发送给一个用户的私有通知；发送方不是另一个用户。
...
**WorkflowOfficialPublisher**：枕星AI助手 用于发布官方 WorkflowRelease 的固定组织服务身份；它不是用户或 reviewer，不能登录，也没有会话、资料、头像或设备关系，公开作者名只投影为“枕星AI助手”。_Avoid_: 普通用户、官方个人账号、审核服务身份
...
**厂商**：
拥有或维护一个或多个目录产品的组织。同一厂商在枕星AI助手 中只有一份身份和资料，可以因旗下不同产品出现在多个目录视图中。
_Avoid_: 品牌、公司
...
**候选目录记录**：
已从厂商官方来源收集，但尚未经过枕星AI助手 审核并发布的厂商或产品资料。
_Avoid_: 新产品、草稿产品
