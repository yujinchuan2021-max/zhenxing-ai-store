...
const RUNTIME_MESSAGES = Object.freeze({
  zh: Object.freeze({
    ...
    SYSTEM_TITLE: "AI Hub",
    SYSTEM_ACTION: "操作",
    TRAY_BACKGROUND: "AI Hub · 后台运行",
    TRAY_TASKS: "AI Hub · {count} 个任务进行中",
    TRAY_NONE: "当前没有进行中的任务",
    TRAY_OPEN_TASKS: "打开任务中心",
    TRAY_OPEN_HUB: "打开 AI Hub",
    TRAY_EXIT: "完全退出",
  ...
  en: Object.freeze({
    ...
    TRAY_BACKGROUND: "AI Hub · Running in background",
    TRAY_TASKS: "AI Hub · {count} active task(s)",
    TRAY_NONE: "No active tasks",
    TRAY_OPEN_TASKS: "Open task center",
    TRAY_OPEN_HUB: "Open AI Hub",
    TRAY_EXIT: "Quit",
