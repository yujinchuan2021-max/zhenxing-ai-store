...
| Logo、头像与图片破图 | `2026-07-31-account-avatar-language-and-button-feedback.md`、`2026-08-02-vendor-logo-assets.md`、`2026-08-02-catalog-logo-release-host-and-renderer-readiness.md` | 图片使用受控源、内容哈希和明确 CSP；HTTP 200、目录验签与界面实际解码必须分别验证。 |
