...
| Logo、头像与图片破图或错配 | `2026-07-31-account-avatar-language-and-button-feedback.md`、`2026-08-02-vendor-logo-assets.md`、`2026-08-02-catalog-logo-release-host-and-renderer-readiness.md`、`2026-08-03-vendor-logo-identity-and-contrast.md`、`2026-08-16-modern-visual-system-and-client-update-channel.md` | 图片使用受控源、内容哈希和明确 CSP；还必须核验品牌身份、唯一归属、最终对比度和打包后 `file://` 资源加载，开发服务器成功或 HTTP 200 不代表安装包可显示。 |
