...
const messages = {
  zh: {
    ...
    "resources.description": "按目标 AI 厂商和产品查找可用资源。只有点击安装后，客户端才会执行本地检查。",
  ...
  en: {
    ...
    "resources.description": "Browse resources by target AI vendor and product. Local checks start only after you click install.",
