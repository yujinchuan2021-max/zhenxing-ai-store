...
const offer = {
  version: "0.1.1",
  downloadUrl:
    "https://updates.zhenxingai.com/ZhenXing-AI-0.1.1-Windows-x64-Setup.exe",
  sha256: digest,
  fileSize: 123
};
const channel = {
  allowedReleaseOrigins: ["https://updates.zhenxingai.com"]
};
      ...
      planUpdateInstallerDownload(
        {
          ...offer,
          downloadUrl:
            "https://updates.zhenxingai.com:4444/ZhenXing-AI-0.1.1-Windows-x64-Setup.exe"
        },
        channel,
        path.resolve("C:\\AIHub\\updates")
      ),
